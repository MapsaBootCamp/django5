...
ROOT_URLCONF = 'rishoGheichi.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'users.context_processors.hero',
            ],
        },
    },
]

WSGI_APPLICATION = 'rishoGheichi.wsgi.application'
...
STATICFILES_FINDERS = [
    ...
    'resume.static_finder.CustomAppDirectoriesFinder',
]
